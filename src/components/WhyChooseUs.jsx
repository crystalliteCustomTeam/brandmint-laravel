...
const WhyChooseUs = ({
  ...
  title = "Because We HelpYour Business Get <br className='lg:block hidden'/> Bigger Every Passing Day!",
          ...
          <div className="grid md:grid-cols-3 grid-cols-1 items-center gap-3">
            {data?.map(([image, title, desc], i) => (
              <div
                ...
                className={`relative flex flex-col justify-center gap-3 md:min-h-[450px] min-h-[400px] hover:border-[1px] hover:border-solid hover:shadow-lg lg:px-[25px] px-[15px] lg:py-[50px] py-[30px] hover:rounded-[30px] group ${
                  i === activeIndex ? "border-[1px] shadow-lg border-solid rounded-[30px]" : ""
                }`}
              >
