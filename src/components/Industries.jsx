      ...
      <div >
        <div className="container">
          <div className="text-center mb-12">
            ...
            {title && <h3 className={`lg:text-[45px] xs:text-[30px] xs:pb-[10px]  text-[40px] font-semibold text-[#202124] ${theme == "light" ? "text-[#202124]" : "text-white"} mb-2`} dangerouslySetInnerHTML={{__html: title}} />}
            {desc && (
              <p
