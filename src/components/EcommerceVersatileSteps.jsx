                ...
                <div className="container">
                    ...
                    <div className="mt-10 relative">
                        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3 lg:gap-3 xl:gap-5">
                            <ColoCard Color="bg-[#0085F8]"  title="eCommerce Content Marketing" description="Boost your brand engagement and improve search engine rankings with SEO Company. Our eCommerce SEO content marketing strategies are crafted to enhance brand awareness and effectively promote your products. We specialize in creating engaging blog posts, compelling product descriptions, and impactful social media content to elevate your brand authority."/>
                            ...
                            Management" description="Expanding your eCommerce store globally involves connecting with your target audience at the opportune moment through the appropriate social media platforms. At SEO Company, we specialize in eCommerce optimization strategies designed to achieve this goal. Our eCommerce marketing services include thorough advertising analyses to attract qualified traffic from high-intent customers." />
                            <ColoCard Color="bg-[#000000]" BgImage={seoImageFour} title="Keyword Research and Optimization" description="SEO Company specializes in eCommerce SEO, understanding your niche, and enhancing your rankings for targeted search terms. Our eCommerce SEO specialists review your current keyword rankings and perform detailed keyword research to curate a strategic list tailored to your website and the digital marketplace."/>

                            <ColoCard Color="bg-[#F8BA05]" BgImage={seoImageFive} title="Product Image Optimization" description="Uncertain how potential buyers search for products on your eCommerce store. Don't worry about uploading product images online, as SEO Company's product image optimization services, crafted by expert SEO specialists, ensure your products gain visibility on the top pages searched by your target audience. Trust our tailored eCommerce SEO solutions to enhance your product visibility and attract more customers effectively."/>
