        ...
        <div>
            <div className="container">
                <div>
                  ...
                  px] sm:text-[14px]  md:text-[14px] lg:text-[14px] xl:text-[16px] font-light">Hoping for a surge in your business growth? Witness our expertise in Google Screened Ads and the assurance that Google Screened will bring more clients to your business!</p>
                </div>
                <div className="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-2 lg:gap-5 my-10">
                  ...
                  <COLORCARD title="Google Screened Ads" image={googleLocalAds} btnText="View More" btnColor="bg-[#ED876F]" description="Looking to naturally capture leads? Probe into the dynamics of Google Screened and see how SEO Company makes it easier than ever with Google Screened Ads!"/>
