          ...
          items={[
            {
              ...
              content: "Our local SEO Company conducts an exhaustive local SEO audit to define your existing local SEO ranking, acquire actionable insights and make your local SEO checklist. Jumpto1 checks your NAP visibility, determines your geographical area and service zones, and investigates your Google My Business listing. To achieve your local SEO strategy, our local SEO specialists also execute a Google My Business page audit, examine analysis, audit the landing page, analyze local citations, opponent benchmarking, and analyze organic links.",
              borderColor: "border-[#0085F8]"
            },
            {
              no: "02",
              title: "Keyword Research & Strategy",
              content: "We conduct extensive keyword investigation and analysis to recognize geo-specific, industry-corresponding keywords and categorize them by search intent. Once Jumpto1’s local SEO specialist has outlined your search terms, he makes a local SEO manual to help you devise locally-centric website content.",
            ...
            },
            {
              no: "04",
              title: "Link Building",
              content: "We ensures search engines discover an authentic manifestation of your business across the web. We create hyperlocal SEO landing pages, construct your local SEO citations, powers keywords with high domain relevancy, and project email outreach movements. We pursue local link-building and GMB SEO best techniques to draw links that produce the results for your company.",
              borderColor: "border-[#000000]"
            },
            {
              no: "05",
              title: "Business Citation Management",
              content: "Local SEO citations serve as an authority for your company name and address on another website. Jumpto1’s Google My Business specialists leverage high-end third-party sites to create local citations for your enterprise. We also explore industry-based niche directories and advance your business information to acquire the maximum authority of your online presence.",
              borderColor: "border-[#F8BA05]"
            },
            {
              no: "06",
              title: "Online Reputation Management (ORM)",
              content: "Online reviews can deliver favorable evidence about your company and help improve customer trust. According to studies, 88 percent of customers check online reviews before buying local services. We protect your brand prestige by monitoring the customers' mentions across many sites.",
              borderColor: "border-[#0085F8]"
            },
            {
              no: "07",
              title: "Content Writing",
              content: "With a team of expert writers, we create well-researched and optimized content. They closely follow the local SEO guidelines to curate content that ranks high on the search engines. We help you become friends with your ideal customers with appealing and relevant titles and headlines.",
              borderColor: "border-[#EF4252]"
            },
            {
              no: "08",
              title: "Conversion Rate Optimization (CRO)",
              content: "We take a deeper look at your website to learn the elements that hinder the users from getting converted. With our CRO specialists, we ensure your website gets optimized to the level of finesse.",
              borderColor: "border-[#34A854]"
            },
            {
              no: "09",
            ...
            },
            {
              ...
              content: "We conduct business the right way! We are Known for its two core values: Integrity and Results. We take satisfaction in what we do and always strive for excellence with total honesty and integrity.",
              borderColor: "border-[#F8BA05]"
            }
