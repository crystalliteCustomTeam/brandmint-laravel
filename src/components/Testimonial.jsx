      ...
      <div>
        <div className="container">
          <div className="text-center mb-12">
            ...
            {desc && (
              <p
                className={`text-[14px] lg:text-[16px] 2xl:w-[75%] lg:w-[85%] mx-auto block leading-[26px]`}
                dangerouslySetInnerHTML={{__html: desc}}
              />
            )}
          </div>
          <div className={`grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 gap-x-4 gap-y-5 mb-10`}>
            {data?.map((e, i) => (
              <div key={i} className={`bg-transparent border-[1px] shadow-lg rounded-[15px] py-8 px-6 transition-all ease-in-out duration-1000 group items-center overflow-hidden relative xl:min-h-[350px] lg:min-h-[380px] min-h-[320px]`}>
