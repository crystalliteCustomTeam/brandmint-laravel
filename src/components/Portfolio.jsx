        ...
        <div className="container">
          <div className="text-center mb-8">
            ...
            <p className={`text-[14px] lg:text-[16px] mx-auto block leading-[26px] font-light`}>
              Our expert team prioritizes your extraordinary needs to create professional website development services solutions that align perfectly with your idea.<br className='hidden lg:block' /> We believe in breaking boundaries and setting new standards, making our work stand out a mile globally.
            </p>
          </div>
