    ...
    return (
        <main>
            ...
            <div>
                ...
                title={`Don’t Just Wait for Miracles, <br className='hidden sm:block' />
            ...
            <div className="xs:py-[50px] py-[90px]" >
                <Contact
                title={`Claim Your <strong>Complimentary 30-minute </strong><br className="hidden sm:block"/>
                Strategy Session with a Professional<br className="hidden sm:block"/>
