            ...
            <div className="text-white grid md:grid-cols-12 gap-x-5 items-center">
              <div className="lg:col-span-8 md:col-span-6 md:pl-8">
                ...
                <div className="flex gap-2 mt-5">
                  <CTA text={"GET STARTED NOW"} className="!bg-black !text-white" />
                  <CTA text={"Contact"} className="!bg-white !text-black" />
                </div>
              </div>
              <div className="lg:col-span-4 md:col-span-6">
                <Image
                  src={CallAwayImage}
                  alt="Call Away"
                  className="md:block hidden xl:absolute xl:max-w-[380px] 2xl:max-w-[450px] lg:max-w-[300px] static 2xl:-top-[16%] xl:top-[-35px] top-[-110px]"
                />
              </div>
            </div>
          </div>
