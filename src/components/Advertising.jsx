        ...
        <div>
            <div className="container">
                ...
                <div className="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-2 lg:gap-5 my-10">
                  <COLORCARD title="Facebook Advertising" image={Facebook} btnText="Advertising on Facebook" btnColor="bg-[#26ABFF]" description="If you seek professional Facebook Advertising Services, you have come to the rightplace. We will help you reach your targeted audience using the most sought-aftersocial media platform." />
